    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while($row=mysqli_fetch_assoc($result)){
            if($id == $row['id']){
               ...
               echo '<div id="options">';
                   echo '<div><input type="radio" id="opt1" name="html" value="opt1"';
                   if($chk==true && $radio=='opt1'){echo'checked';}
                   echo'>';echo $row['opt1']; echo'</div>';
                   echo '<div><input type="radio" id="opt2" name="html" value="opt2"';
                   if($chk==true && $radio=='opt2'){echo'checked';}
                   echo'>';echo $row['opt2'];echo'</div>';
                   echo '<div><input type="radio" id="opt3" name="html" value="opt3"';
                   if($chk==true && $radio=='opt3'){echo'checked';}
                   echo'>';echo $row['opt3'];echo'</div>';
                   echo '<div><input type="radio" id="opt4" name="html" value="opt4"';
               ...
               echo '<button  id="update"><a href="html.php?id=';echo $id+1;echo '">';
